# XRay Android Emulator Compatibility v26.6.22

Changes:

* Rebuilt bundled emulator `libxray.so` binaries against XTLS/Xray-core `v26.6.22` for `x86` and `x86_64`.
* Kept this package marked as legacy because the main Maven runtime `dev.tfox.fluttervless:xray-android:26.6.22` includes emulator ABIs.
