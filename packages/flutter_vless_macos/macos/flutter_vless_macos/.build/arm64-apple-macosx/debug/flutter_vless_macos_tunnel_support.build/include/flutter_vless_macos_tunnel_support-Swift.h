...
#ifndef FLUTTER_VLESS_MACOS_TUNNEL_SUPPORT_SWIFT_H
#define FLUTTER_VLESS_MACOS_TUNNEL_SUPPORT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flutter_vless_macos_tunnel_support",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSObject;
@class NSData;
SWIFT_CLASS("_TtC34flutter_vless_macos_tunnel_support32FlutterVlessPacketTunnelProvider")
@interface FlutterVlessPacketTunnelProvider : NEPacketTunnelProvider
